# Tarefa de SO - Arquivos em Python
...
### 3. Em complemento ao enunciado anterior, fazer uma aplicação Python, que leia o arquivo com os termos da série de Fibonacci e imprima na tela só os números ímpares. A aplicação deve ter um procedimento de leitura, uma função que valida se o número é ímpar e retorne o número para ser impresso. Caso não seja ímpar, a função deve retornar -1, que não deve ser impresso em console.
